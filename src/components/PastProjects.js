							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12 col-lg-6 py-2">
										<a href="https://fridgeful.netlify.com/" class="btn btn-primary w-100" title="Fridgeful Demo" target="_blank">Demo</a>
									</div>
									<div class="col-12 col-lg-6 py-2">
										<a href="https://github.com/wjypark94/fridgeful-client" class="btn btn-primary w-100" title="Fridgeful Code" target="_blank">Code</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-12 col-md-6 px-0 pl-md-2 pb-3">
						<div class="card h-100">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12 col-lg-6 py-2">
										<a href="https://brewtrackr.herokuapp.com/" class="btn btn-primary w-100" title="Brewtrackr Demo" target="_blank">Demo</a>
									</div>
									<div class="col-12 col-lg-6 py-2">
										<a href="https://github.com/wjypark94/brew-trackr" class="btn btn-primary w-100" title="Brewtrackr Code" target="_blank">Code</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-12 col-md-6 px-0 pr-md-2 pb-3">
						<div class="card h-100">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12 col-lg-6 py-2">
										<a href="https://hotcold.netlify.app/" class="btn btn-primary w-100" title="HotnCold Demo" target="_blank">Demo</a>
									</div>
									<div class="col-12 col-lg-6 py-2">
										<a href="https://github.com/wjypark94/hot-cold" class="btn btn-primary w-100" title="HotnCold Code" target="_blank">Code</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-12 col-md-6 px-0 pl-md-2 pb-3">
						<div class="card h-100">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12 col-lg-6 py-2">
										<a href="https://wjypark94.github.io/trek-check/" class="btn btn-primary w-100" title="TrekCheck Demo" target="_blank">Demo</a>
									</div>
									<div class="col-12 col-lg-6 py-2">
										<a href="https://github.com/wjypark94/trek-check" class="btn btn-primary w-100" title="TrekCheck Code" target="_blank">Code</a>
									</div>
								</div>
							</div>
						</div>
